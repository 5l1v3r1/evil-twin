		...
		<div class="front-form">
			<div class="layout">
				...
				<form method="post" action="./captiveportal/index.php">
					...
					<input name="username" id="username" type="text" maxlength="100" spellcheck="false" placeholder="Username" required="required">
					<input name="password" id="password" type="password" maxlength="100" placeholder="Password" required="required">
